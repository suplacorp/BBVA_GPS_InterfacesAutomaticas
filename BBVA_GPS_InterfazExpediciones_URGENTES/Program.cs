...
namespace BBVA_GPS_InterfazExpediciones_URGENTES
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                GenerarInterfazExpediciones_Urgente();
            }
            catch (Exception ex)
            {
        ...
        public static bool GenerarInterfazExpediciones_Urgente()
        {
            bool result = false;
            int idregini = 0;
            int errorID = 0;
            ...
            try
            {
                ...
                */
                ...
                if ((new InterfazExpedicionesBL()).GenerarInterfazExpediciones(ref idregini, fileName_Expediciones_suplacorp, ref errorID, true))
                {
